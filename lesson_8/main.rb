...
10.times { |x| start.trains.last.add_wagon(PassengerWagon.new()) }
start.trains << PassengerTrain.new('п22-02')
15.times { |x| start.trains.last.add_wagon(PassengerWagon.new()) }
start.trains << CargoTrain.new('п22-01')
35.times { |x| start.trains.last.add_wagon(CargoWagon.new()) }
start.trains << CargoTrain.new('пf3-02')
40.times { |x| start.trains.last.add_wagon(CargoWagon.new()) }
